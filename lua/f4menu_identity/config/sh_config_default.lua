...
F4Menu.Settings.VersionDefault = "1.2.0" --DON'T TOUCH THIS
...
F4Menu.Settings.Navigation =
{
    ...
    },
    {
        ...
        Visible = function(ply) return !!DarkRP end,
        NotDrawLine = false,
        ColorLine = Color( 255, 255, 255, 100 ),
        ColorBase = Color(33, 31, 35, 200),
        ColorHover = Color( 0, 0, 0, 100 ),
...
F4Menu.Settings.Commandes = {
    ["Money"] = {
        visible = function() return !!DarkRP end,
    ...
    ["Police"] = {
        visible = function(ply) return !!DarkRP and F4Menu.AccessToCPCmds[ply:Team()] end,
    ...
    ["Mayor"] = {
        visible = function(ply) return !!DarkRP and F4Menu.AccessToMayorCmds[ply:Team()] end,
